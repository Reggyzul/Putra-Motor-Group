...
const supabaseUrl = process.env.VITE_SUPABASE_URL || 'https://baslrzduqfqrrozbwgwh.supabase.co';
const supabaseKey = process.env.VITE_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJhc2xyemR1cWZxcnJvemJ3Z3doIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODg2NjgzOTIsImV4cCI6MjEwNDI0NDM5Mn0.ZKhJ3efXOxOEuiemzZ56w1WJVuqrJ41KaJ9ezVqynUM';
